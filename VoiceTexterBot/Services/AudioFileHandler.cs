...
namespace VoiceTexterBot.Services
{
    public class AudioFileHandler : IFileHandler
    {
        ...
        {
            string inpputAudioPath = Path.Combine(_appSettings.DownloadsFolder, $"{_appSettings.AudioFileName}.{_appSettings.InputAudioFormat}");
            ...
            AudioConverter.TryConvert(inpputAudioPath, outputAudioPath);
